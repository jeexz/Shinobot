...
/////////////////
const BotName = 'SHINO BOT☄'; 
const instagram = 'https//instagram.com/mpxxiit'; 
const telegram = 'ga ada'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@jeexz.id')
